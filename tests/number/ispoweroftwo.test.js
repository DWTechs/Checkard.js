...
test("sends 2 integer as string to isPowerOfTwo", () => {
  expect(isPowerOfTwo("2")).toBe(false);
});

test("sends 16 integer as string to isPowerOfTwo", () => {
  expect(isPowerOfTwo("16")).toBe(false);
});

test("sends 1 integer as string to isPowerOfTwo", () => {
  expect(isPowerOfTwo("1")).toBe(false);
});

test("sends zero as string to isPowerOfTwo", () => {
  expect(isPowerOfTwo("0")).toBe(false);
});

test("sends positive float as string to isPowerOfTwo", () => {
  expect(isPowerOfTwo("1.1")).toBe(false);
});

test("sends negative odd integer as string to isPowerOfTwo", () => {
  expect(isPowerOfTwo("-1")).toBe(false);
});

test("sends negative even integer as string to isPowerOfTwo", () => {
  expect(isPowerOfTwo("-2")).toBe(false);
});

test("sends negative float as string to isPowerOfTwo", () => {
  expect(isPowerOfTwo("-1.1")).toBe(false);
});

test("sends 2 integer as string to isPowerOfTwo without type check", () => {
  expect(isPowerOfTwo("2", false)).toBe(true);
});

test("sends 16 integer as string to isPowerOfTwo without type check", () => {
  expect(isPowerOfTwo("16", false)).toBe(true);
});

test("sends 1 integer as string to isPowerOfTwo without type check", () => {
  expect(isPowerOfTwo("1", false)).toBe(true);
});

test("sends zero as string to isPowerOfTwo without type check", () => {
  expect(isPowerOfTwo("0", false)).toBe(false);
});

test("sends positive float as string to isPowerOfTwo without type check", () => {
  expect(isPowerOfTwo("1.1", false)).toBe(false);
});

test("sends negative odd integer as string to isPowerOfTwo without type check", () => {
  expect(isPowerOfTwo("-1", false)).toBe(false);
});

test("sends negative even integer as string to isPowerOfTwo without type check", () => {
  expect(isPowerOfTwo("-2", false)).toBe(false);
});

test("sends negative float as string to isPowerOfTwo without type check", () => {
  expect(isPowerOfTwo("-1.1", false)).toBe(false);
});
