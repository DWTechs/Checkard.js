 ...
 */
function isInteger(n: number | string, type = true): boolean {
 ...
 */
function isFloat(n: number | string, type = true): boolean {
  const num = Number(n);
 ...
 */
function isEven(n: number | string, type = true): boolean {
 ...
 */
function isOdd(n: number | string, type = true): boolean {
